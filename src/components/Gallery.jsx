const Gallery = ({ images }) => {
  const products = [
    { brand: 'Nature', name: 'Artistic Landscape' },
    { brand: 'Urban', name: 'Beautiful landscape' },
    { brand: 'Abstract', name: 'Modern Art' },
  ];
                ...
                <div className="flex items-center">
                  <div className="ml-auto">
                    <svg
                      ...
                      height="20"
                      fill="currentColor"
                      className="bi bi-bag-plus hover:text-blue-600 transition-colors duration-200 cursor-pointer"
                      viewBox="0 0 16 16"
                    >
                      <path
                        fillRule="evenodd"
